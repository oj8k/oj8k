...
☆-完美解决电脑版Openvpn无法连接问题            
                                                
☆-By：Dxy 国内高速SSR,OP上车加微信
...
# 快云开机自启脚本 请自行添加">>/Data/start.sh
  ...
  if [ $NowV != '4.13.7-1.el7.elrepo.x86_64' ];then
    ...
    elrepo='欢迎你使用快云VPN产品,如果你有Bug和好的建议反馈给我们，欢迎联系邮箱：623549199@qq.com'
  fi
fi
clear
echo -e "
...
国内高速SSR,OP,V2ray上车，以及有偿解决快云以及其他免流问题
联系微信备注来意，微信：623549199
